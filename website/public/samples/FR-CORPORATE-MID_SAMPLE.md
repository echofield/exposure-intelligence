...
- Tout élément indiquant que les sorties de notation CRM ont été référencées dans des entretiens d’évaluation individuels, des décisions de territoire ou des discussions de rémunération.
...
| Juridiction | France |
| Secteur | Services professionnels B2B |
| Taille d’entreprise | ETI, taille intermédiaire |
| Tranche de CA | 150–200 M€ |
| Tranche d’effectif | 500–1 500 |
| Catégorie de surface IA | Outils de productivité + aide à la décision, notation gérée par l’éditeur |
| Fonctions concernées | Commercial, RH indirect, Opérations, Direction |
| Modèle de déploiement | SaaS intégré, Copilot + notation CRM gérée par l’éditeur |
...
| Cadre | Applicabilité |
|---|---|
| Règlement (UE) 2024/1689 sur l’intelligence artificielle | Applicable progressivement. Les chapitres I et II s’appliquent depuis le 2 février 2025 ; certaines dispositions de gouvernance, de sanctions et relatives aux modèles d’IA à usage général s’appliquent depuis le 2 août 2025 ; le régime général s’applique à partir du 2 août 2026, avec certaines obligations liées aux systèmes à haut risque à partir du 2 août 2027. |
...
- Ce rapport suppose des conditions contractuelles standard pour Microsoft 365 Copilot, licence entreprise M365 E3/E5, et pour une plateforme CRM standard destinée aux ETI, Salesforce ou équivalent. Des stipulations négociées individuellement peuvent modifier l’analyse de dépendance et d’auditabilité.
...
- Les calendriers d’application du règlement IA sont échelonnés et peuvent être affectés par les mesures européennes de mise en œuvre. Les dates et obligations doivent être confirmées au moment de la revue.
...
- Accord de traitement Microsoft 365 Copilot : vérifier si l’avenant de traitement existant couvre explicitement les opérations IA réalisées par Copilot, notamment résumé de courriels, transcription de réunions, analyse de documents et recherche. Confirmer que les clauses de localisation des données couvrent l’ensemble du traitement IA, et pas uniquement le stockage.
- Conditions IA de l’éditeur CRM : vérifier si elles incluent des obligations de sous-traitant pour le traitement, par l’assistant de notation, des données de contacts et des données attribuées aux salariés. Confirmer la présence d’une notification de changement de modèle, de droits d’audit et d’obligations de suppression.
...
**Notation CRM :** partiellement réversible. La fonction de notation peut être désactivée si la configuration de l’éditeur le permet. La plateforme CRM elle-même est une dépendance critique sous contrat pluriannuel. Un remplacement complet exigerait au minimum 12 à 18 mois. La désactivation de la seule notation est possible mais non documentée. Réversibilité pratique : faible à moyenne.
...
- **Inscriptions au registre des traitements :** le registre ne contient pas d’inscriptions distinctes pour les opérations IA de Copilot ni pour les flux de l’assistant de notation CRM.
- **Procédure de supervision humaine de la notation CRM :** aucune procédure documentée définissant qui revoit les sorties, sous quelles conditions une neutralisation est permise, et comment elle est consignée.
...
- **Procès-verbal de consultation du CSE :** aucun élément n’indique que le Comité social et économique a été informé et consulté sur le déploiement de Copilot ou de l’outil de notation CRM. L’existence d’une obligation de consultation requiert une appréciation juridique.
...
- Si les indicateurs individuels de l’assistant de notation CRM ont été consultés, référencés ou utilisés dans une évaluation, un calcul de prime ou une décision d’emploi. C’est le point d’inflexion principal de l’exposition RH.
...
- Si la liste des sous-traitants ultérieurs de Microsoft pour les fonctions IA de Copilot inclut une infrastructure hors EEE, et si le mécanisme de transfert de l’accord de traitement actuel couvre ces transferts de manière adéquate.
- La configuration précise du modèle de notation CRM : quelles entrées il utilise, comment il pondère les variables attribuées aux salariés, et si une sortie constitue une décision juridique ou produisant des effets similaires significatifs.
...
- [ ] Inscriptions au registre des traitements pour Copilot et la notation CRM comme opérations distinctes.
- [ ] Procédure de supervision humaine des sorties de notation CRM.
- [ ] Politique d’usage de l’IA communiquée à l’ensemble des salariés.
- [ ] Procès-verbal de consultation du CSE pour les déploiements de Copilot et de la notation CRM.
...
2. Registre fournisseurs : créer un registre à deux colonnes, fournisseur IA et statut de l’accord de traitement / couverture du traitement IA. Pour Microsoft, confirmer si l’accord de traitement actuel couvre explicitement les opérations IA de Copilot. Pour l’éditeur CRM, confirmer quelles conditions de traitement régissent spécifiquement l’assistant de notation.
...
|---|---|---|
| Les sorties de notation CRM ont été référencées dans une évaluation, une décision de prime ou une allocation de territoire individuelles | Emploi + traitement automatisé | Immédiate |
...
| L’outil de notation CRM est apprécié comme relevant d’une catégorie réglementée à haut risque au regard de son usage à proximité de l’emploi | Conformité règlement IA | Immédiate |
...
| CSE non consulté avant le déploiement de Copilot ou de la notation CRM | Procédure emploi | Court terme |
| Accord de traitement fournisseur jugé ne pas couvrir le traitement par les fonctions IA comme activités distinctes | Traitement de données | Court terme |
...
- L’assistant de notation CRM est une fonction standard de la plateforme CRM, Salesforce Einstein ou équivalent fonctionnel. Les scores sont générés à partir des seules données internes du CRM. Aucune intégration de données externe n’est supposée.
- L’organisation commerciale est structurée autour de commerciaux individuels dotés de comptes et d’objectifs de tunnel commercial attribués. Les scores CRM sont visibles à la fois par les commerciaux et leurs responsables.
...
- [ ] Contrat-cadre de l’éditeur CRM et conditions de la fonction IA / notation.
- [ ] Registre des traitements, pour vérifier les inscriptions Copilot et notation CRM.
- [ ] Toute documentation d’AIPD existante pour les outils numériques de travail.
- [ ] Procès-verbaux du CSE pour la période de déploiement de Copilot et de la notation CRM.
...
**Règlement IA, Règl. (UE) 2024/1689 :** règlement européen sur l’intelligence artificielle. Son application est échelonnée entre 2025 et 2027. Il crée différents ensembles d’obligations selon la classification de risque du système IA et le rôle de fournisseur ou de déployeur. Une revue par un conseil est requise pour déterminer les obligations applicables à un déploiement donné.
...
**Registre des traitements :** registre interne que les organisations doivent tenir, documentant leurs opérations de traitement : finalité, catégories de données, destinataires, durées de conservation. Les outils IA traitant des données personnelles doivent y figurer comme inscriptions distinctes.

**AIPD :** analyse d’impact relative à la protection des données. Évaluation structurée requise avant des traitements susceptibles d’engendrer un risque élevé pour les personnes. Apprécie la nécessité, la proportionnalité et l’atténuation des risques du traitement envisagé.

**Accord de traitement :** contrat requis entre un responsable de traitement et un sous-traitant lorsque des données personnelles sont confiées pour traitement. Doit en préciser la portée, la finalité et les conditions.
...
3. Le CSE a-t-il été informé et consulté avant le déploiement de Copilot et de l’outil de notation CRM ?
4. Les salariés savent-ils que Copilot peut transcrire leurs réunions et traiter le contenu de leurs courriels ?
5. Des sorties de notation CRM ont-elles déjà été référencées dans une évaluation, une discussion de prime ou une décision d’emploi concernant un commercial ?
6. L’accord de traitement Microsoft actuel couvre-t-il explicitement les opérations IA de Copilot ?
7. Quelles sont les conditions de l’éditeur CRM régissant le traitement de données par l’assistant de notation ?
